...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <div class="button-items">
                                        <a href="#modalEdit{{$currency->id}}" class="btn btn-warning waves-effect waves-light" data-toggle="modal" data-target="#modalEdit{{$currency->id}}"><i class="mdi mdi-pencil-outline"></i></a>
                                        <a class="btn btn-danger waves-effect waves-light" href="#" data-uri="{{route('currencies.destroy', $currency->id)}}" data-toggle="modal" data-target="#modalDestroy"><i class="mdi mdi-delete"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <form action="{{ route('currencies.store') }}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="primary-header-modalLabel">Tambah Mata Uang
                                </h4>
            ...
            @foreach ($c as $currency)
            <div id="modalEdit{{$currency->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{ route('currencies.update', $currency->id) }}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="primary-header-modalLabel">Ubah Mata Uang
                                </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="currency" class="form-control" value="{{ $currency->currency }}">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
