        ...
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <div class="button-items">
                                        ...
                                        <a class="btn btn-danger waves-effect waves-light" href="#" data-uri="{{route('pers.destroy', $q->id)}}" data-toggle="modal" data-target="#modalDestroy"><i class="mdi mdi-delete"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
            ...
            <div id="modalCreate" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{ route('pers.store') }}" method="POST">
                        @csrf
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="persentase_keuntungan" class="form-control">
                                </div>
                            </div>
            ...
            <div id="modalEdit{{$q->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{ route('pers.update', $q->id) }}" method="POST">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="primary-header-modalLabel">Ubah Persentase
                                </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="persentase_keuntungan" class="form-control" value="{{ $q->persentase_keuntungan }}">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
