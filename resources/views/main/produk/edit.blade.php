...
<div class="col-12">
    <div class="card">
        ...
        <form action="{{route('produk.update', $produk->id )}}" method="POST" enctype="multipart/form-data" class="needs-validation">
            @csrf
            {{ method_field('PUT') }}
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control selectric" name="currency_id" required>
                                ...
                                @if($produk->currency_id == $q->id)
                                <option value="{{ $q->id }}" selected>{{ $q->currency }}</option>
                                @else
                    ...
                    <div class="col-12 col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control selectric" name="unit_id" required>
                                <option value="">&mdash;</option>
                                @foreach($unit as $q)
                                @if($produk->unit_id == $q->id)
                                <option value="{{ $q->id }}" selected>{{ $q->unit }}</option>
                                @else
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{$produk->diskon}}" name="diskon">
                            <div class="invalid-feedback">
                                Isi Diskon Produk!
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="keterangan" required="">{{ $produk->keterangan }}</textarea>
                            <div class="invalid-feedback">
                                Isi Form Deskripsi!
                            </div>
                        </div>
                ...
                <button class="btn btn-warning" id="submit-btn">Ubah</button>
            </div>
        </form>
    </div>
</div>
