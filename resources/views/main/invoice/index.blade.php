            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="button-items" style="text-align:right;">
                        <a target="blank" href="{{route('printRiwayatTransaksi')}}" class="btn btn-info waves-effect waves-light"><i class="dripicons-print"></i> 🡒</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('invoice.show', $q->kode_unik) }}" class="btn btn-success btn-sm">Rincian</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
