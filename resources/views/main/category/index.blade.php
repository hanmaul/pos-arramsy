    ...
    <div class="card">
        ...
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <div class="button-items">
                                        ...
                                        <a class="btn btn-danger waves-effect waves-light" href="#" data-uri="{{route('category.destroy', $q->id)}}" data-toggle="modal" data-target="#modalDestroy"><i class="mdi mdi-delete"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <form action="{{ route('category.store') }}" method="POST">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="primary-header-modalLabel">Tambah Kategori
                                </h4>
            ...
            <div id="modalEdit{{$q->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="{{ route('category.update', $q->id) }}" method="POST">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="category" class="form-control" value="{{ $q->category }}">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
